...
//MARK: PageList
#define kTableViewCellWidth 150 * kScreenAdaptationRadio
...
#define kCellLeftMargin 5 * kScreenAdaptationRadio

#define kCellRightmarin 5 * kScreenAdaptationRadio
...
#define kCellHeight 40 * kScreenAdaptationRadio
