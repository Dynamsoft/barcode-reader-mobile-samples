...
class BasicNumberInputTableViewCell: UITableViewCell, UITextFieldDelegate {

    var questionCompletion: QuestionCompletion?
    var inputTFNumberChangedCompletion: InputTFNumberChangedCompletion?
    ...
    @objc private func doneButtonClicked(_ button: UIButton) -> Void {
        ...
        self.inputTFNumberChangedCompletion?(Int(self.inputCountTF.text!)!)
    }
    ...
    func setInputMaxValue(with maxValue: Int) -> Void {
