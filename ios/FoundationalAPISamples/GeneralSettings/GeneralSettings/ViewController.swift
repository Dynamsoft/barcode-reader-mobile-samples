...
class ViewController: UIViewController {
    ...
    func setup(){
        ...
        descriptionLabel.text = "This sample includes general settings for barcode scanning. The settings either enhance decoding performance or improve the user experience during scanning."
