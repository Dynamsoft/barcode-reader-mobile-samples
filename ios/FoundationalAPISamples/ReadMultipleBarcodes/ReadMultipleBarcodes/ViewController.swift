...
class ViewController: UIViewController {
    ...
    func setup(){
        ...
        descriptionLabel.text = "A sample demonstrating how to capture all barcodes within the camera view in a single scan, displaying duplicates with quantity counts for batch inventory scenarios."
