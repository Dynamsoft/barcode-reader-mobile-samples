...
class ViewController: UIViewController {
    ...
    func setup(){
        ...
        descriptionLabel.text = "A sample demonstrating how to continuously scan and collect unique barcodes by moving the camera across different items, with visual feedback to distinguish collected codes from new ones."
