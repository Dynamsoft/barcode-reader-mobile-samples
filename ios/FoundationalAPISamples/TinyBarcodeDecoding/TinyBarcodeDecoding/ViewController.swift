...
class ViewController: UIViewController {
    ...
    func setup(){
        ...
        descriptionLabel.text = "This sample demonstrates how to improve the readability of small-scale barcodes by adjusting the zoom factor or enabling auto-zoom."
