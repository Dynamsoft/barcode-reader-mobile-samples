...
class ViewController: UIViewController {
    ...
    func setup(){
        ...
        descriptionLabel.text = "Scan from the camera and obtain the result of the target barcode. The camera module of this sample is implemented via the Dynamsoft Camera Enhancer library."
