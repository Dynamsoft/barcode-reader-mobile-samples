...
class ViewController: UIViewController, DBRTextResultListener {
    ...
    func configurationDCE() {
        ...
        dce.setFocus(CGPoint(x: 0.5, y: 0.5), focusMode: .FM_CONTINUOUS_AUTO)
    ...
    func addZoomFloatingButton() -> Void {
        ...
        self.cameraZoomFloatingButton = CameraZoomFloatingButton.init(frame: CGRect(x: (kScreenWidth - kCameraZoomFloatingButtonWidth) / 2.0, y: kScreenHeight - bottomHeight - kCameraZoomFloatingButtonWidth, width: kCameraZoomFloatingButtonWidth, height: kCameraZoomFloatingButtonWidth))
    ...
    func addZoomSlider() -> Void {
        ...
        self.cameraZoomSlider = CameraZoomSlider.init(frame: CGRect(x: 0, y: kScreenHeight - bottomHeight - kCameraZoomSliderViewHeight, width: kScreenWidth, height: kCameraZoomSliderViewHeight))
    ...
    func addCameraSettingView() -> Void {
        ...
        self.cameraSettingView = CameraSettingView.init(frame: CGRect(x: 0, y: kScreenHeight - height, width: kScreenWidth, height: height))
    ...
    func addInterestLeadingView() -> Void {
        ...
        self.interestLeadingView = UILabel.init(frame: CGRect(x: (kScreenWidth - leadingWidth) / 2.0, y: (kScreenHeight - leadingWidth) / 2.0, width: leadingWidth, height: leadingWidth))
