...
class ViewController: UIViewController, DBRTextResultListener {
    ...
    func configureDefaultDCE() -> Void {
        GeneralSettings.shared.cameraView = DCECameraView.init(frame: CGRectMake(0, kNaviBarAndStatusBarHeight, kScreenWidth, kScreenHeight - kNaviBarAndStatusBarHeight))
    ...
    func setupUI() -> Void {
        ...
        self.scanLineImageV = UIImageView.init(frame: CGRectMake((kScreenWidth - kScanLineWidth) / 2.0, kNaviBarAndStatusBarHeight + 50, kScanLineWidth, 10))
