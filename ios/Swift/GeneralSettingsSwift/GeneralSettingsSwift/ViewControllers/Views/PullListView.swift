...
class PullListView: UIView, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    private lazy var backgroundMaskView: UIView = {
        let view = UIView.init(frame: CGRectMake(0, 0, self.width, self.height))
    ...
    private lazy var pullListBackgroundView: UIView = {
        let view = UIView.init(frame: CGRectMake(0, self.height - pullListHeight, self.width, pullListHeight))
        view.backgroundColor = .white
        return view
    }()
    
    private lazy var headerView: UIView = {
        let view = UIView.init(frame: CGRectMake(0, 0, self.width, 40))
        view.backgroundColor = .black.withAlphaComponent(0.05)
        return view
    }()
    
    private lazy var titleLabel: UILabel = {
        let label = UILabel.init(frame: CGRectMake((kScreenWidth - 100) / 2.0, 0, 100, self.headerView.height))
    ...
    private lazy var cancelButton: UIButton = {
        let button = UIButton.init(frame: CGRectMake(0, 0, 60, self.headerView.height))
    ...
    private lazy var confirmButton: UIButton = {
        let button = UIButton.init(frame: CGRectMake(kScreenWidth - 60, 0, 60, self.headerView.height))
    ...
    private lazy var pickerView: UIPickerView = {
        ...
        let picker = UIPickerView.init(frame: CGRectMake(0, self.headerView.bottom, kScreenWidth, pickerViewHeight))
    ...
    func pickerView(_ pickerView: UIPickerView, viewForRow row: Int, forComponent component: Int, reusing view: UIView?) -> UIView {
        ...
        let contentLabel = UILabel.init(frame: CGRectMake(0, 0, kScreenWidth, 35))
