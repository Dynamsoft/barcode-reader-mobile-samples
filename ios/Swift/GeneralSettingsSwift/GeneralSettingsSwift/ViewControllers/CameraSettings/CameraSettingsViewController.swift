...
class CameraSettingsViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    private lazy var cameraSettingsTableView = {
    ...
    // MARK: - Notification
    @objc private func keyboardWillShow(_ noti: Notification) -> Void {
        self.view.transform = CGAffineTransformMakeTranslation(0, -100)
    }
    
    @objc private func keyboardWillHide(_ noti: Notification) -> Void {
